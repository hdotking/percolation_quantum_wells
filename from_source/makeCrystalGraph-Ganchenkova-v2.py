...
wrapZ = True # TRUE for a bulk graph (no surfaces, periodic in z), FALSE for a quantum well (surfaces, only periodic in x and y)
export = False
...
if export:
    if wrapZ:
        ...
        nx.write_gpickle(G,str(na)+'x'+str(nb)+'x'+str(nc)+'-graph-Ganchenkova.gpickle')      
